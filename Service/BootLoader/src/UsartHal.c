...
void Usart_enuRecieveBufferSync(pu8 Z_pu8Buffer, u16 copy_u16Size,Usart_tenuBusNum Copy_enuBusNum)
{
	while(copy_u16Size--)
	{
		switch (Copy_enuBusNum)
		{
		case Usart_enuBusNum1:
			Usart_enuRecieveDataSync(USART_1, Z_pu8Buffer++);
			break;
		case Usart_enuBusNum2:
			Usart_enuRecieveDataSync(USART_2, Z_pu8Buffer++);
			break;
		case Usart_enuBusNum6:
			Usart_enuRecieveDataSync(USART_6, Z_pu8Buffer++);
			break;
		}
	}
}
