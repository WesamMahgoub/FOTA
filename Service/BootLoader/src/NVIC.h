...
/****************************************************************
 * Description: 		Get the priority of an interrupt or exception
 *
 * input args: 			Pin number
 *
 * Return type: 		Nvic_enuErrorStatus_t for checking and make validation on the input arg
...
#endif /* NVIC_H_ */
///****************************************************************
// * Description: 		this function to Enable the Interrupt request
// *
// * input args: 			Pin number
// *
// * Return type: 		Nvic_enuErrorStatus_t for checking and make validation on the input arg
...
// *
// */
//Nvic_enuErrorStatus_t Nvic_enuEnableInterrupt();
//
//Nvic_enuErrorStatus_t Nvic_enuDisableInterrupt();
//Nvic_enuErrorStatus_t Nvic_enuSetSubGpPriority();
//Nvic_enuErrorStatus_t Nvic_enuSetSubPriority();
//Nvic_enuErrorStatus_t Nvic_enuSetPending();
//Nvic_enuErrorStatus_t Nvic_enuClearPending();
//Nvic_enuErrorStatus_t Nvic_enuGetActiveStatus();
//Nvic_enuErrorStatus_t Nvic_enuReallocateVectorTable();
//Nvic_enuErrorStatus_t Nvic_enuEncode();
