 ...
 */
Std_enuErrorStatus NVIC_EnableIRQ(Nvic_tenuIRQn Copy_enuIRQn) {
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus NVIC_DisableIRQ(Nvic_tenuIRQn Copy_enuIRQn) {
	/*DEFINE ERROR STATUS VARIABLE*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	/*DEFINE VARIABLE TO CALCULATE INDEX*/
	u8 Loc_u8Index = (u8)Copy_enuIRQn / NVIC_u8REGISTER_SIZE;
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus NVIC_GetPendingIRQ(Nvic_tenuIRQn Copy_enuIRQn, pu8 Add_pu8Pending) {
	/*DEFINE ERROR STATUS VARIABLE*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	/*DEFINE VARIABLE TO CALCULATE INDEX*/
	u8 Loc_u8Index = (u8)Copy_enuIRQn / NVIC_u8REGISTER_SIZE;
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus NVIC_SetPendingIRQ(Nvic_tenuIRQn Copy_enuIRQn) {
	/*DEFINE ERROR STATUS VARIABLE*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	/*DEFINE VARIABLE TO CALCULATE INDEX*/
	u8 Loc_u8Index =(u8) Copy_enuIRQn / NVIC_u8REGISTER_SIZE;
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus NVIC_ClearPendingIRQ(Nvic_tenuIRQn Copy_enuIRQn) {
	/*DEFINE ERROR STATUS VARIABLE*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	/*DEFINE VARIABLE TO CALCULATE INDEX*/
	u8 Loc_u8Index = (u8)Copy_enuIRQn / NVIC_u8REGISTER_SIZE;
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus NVIC_GetActive(Nvic_tenuIRQn Copy_enuIRQn, pu8 Add_pu8Active) {
	/*DEFINE ERROR STATUS VARIABLE*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	/*DEFINE VARIABLE TO CALCULATE INDEX*/
	u8 Loc_u8Index = (u8)Copy_enuIRQn / NVIC_u8REGISTER_SIZE;
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus NVIC_SetPriority(Nvic_tenuIRQn Copy_enuIRQn, u8 Copy_u8Priority) {
	/*DEFINE ERROR STATUS VARIABLE*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	/*VALIDATE IRQ NUMBER*/
	if ((u8)Copy_enuIRQn >= NVIC_u8NUMBER_OF_IRQ) {
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus NVIC_GetPriority(Nvic_tenuIRQn Copy_enuIRQn, pu8 Add_pu8Priority) {
	/*DEFINE ERROR STATUS VARIABLE*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	/*VALIDATE IRQ NUMBER*/
	if ((u8)Copy_enuIRQn >= NVIC_u8NUMBER_OF_IRQ) {
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus NVIC_setSubGroup(u32 Copy_u32SubGroup) {
	/*DEFINE ERROR STATUS VARIABLE*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
