...
Std_enuErrorStatus Uart_vidInit(Uart_Cfg_t * Add_pstrCfg) {
...
extern Std_enuErrorStatus Uart_vidDMACtrl(void * Add_pvChannel ,u32 Copy_u32DmaState)
{
	/*DECLARE RETURN STATUS AND INIT WITH OK*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	...
	if (Add_pvChannel == NULL) {
		...
		case UART_u32DMA_RECIEVE_DISABLE:
			...
			break;
		default:
			Loc_enuReturnStatus = INVALID_ARG;
			break;
		}
	}
...
Std_enuErrorStatus Uart_enuTransmiteData(void * Add_pvChannel,
		u16 Copy_u16Data) {
	/*DECLARE RETURN STATUS AND INIT WITH OK*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	/*ASSIGN THE PASSED CHANNEL INTO POINTER WITH VALID DATATYPE*/
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus Uart_enuRecieveData(void * Add_pvChannel,
		pu16  Add_pu16Data) {
	/*DECLARE RETURN STATUS AND INIT WITH OK*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	/*ASSIGN THE PASSED CHANNEL INTO POINTER WITH VALID DATATYPE*/
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus Uart_ReadTXEFlag	  (void * Add_pvChannel , pu8 Add_pu8FlagStatus)
{
	/*DECLARE RETURN STATUS AND INIT WITH OK*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	Usart_Regitsers_t * Loc_pstrUartChannel = Add_pvChannel;
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus Uart_ReadTCFlag	  (void * Add_pvChannel , pu8 Add_pu8FlagStatus)
{
	/*DECLARE RETURN STATUS AND INIT WITH OK*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	Usart_Regitsers_t * Loc_pstrUartChannel = Add_pvChannel;
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
Std_enuErrorStatus Uart_ClearTCFlag	  (void * Add_pvChannel)
{
	/*DECLARE RETURN STATUS AND INIT WITH OK*/
	Std_enuErrorStatus Loc_enuReturnStatus;
	Usart_Regitsers_t * Loc_pstrUartChannel = Add_pvChannel;
	/*VALIDATE ON THE ARGUMENTS*/
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
extern Std_enuErrorStatus Uart_ReadRXNEFlag	  (void * Add_pvChannel , pu8 Add_pu8FlagStatus)
{
	/*DECLARE RETURN STATUS AND INIT WITH OK*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	Usart_Regitsers_t * Loc_pstrUartChannel = Add_pvChannel;
 ...
 *  CHECK Std_enuErrorStatus ERROR ENUM.
 */
extern Std_enuErrorStatus Uart_enuControlRXNEInterrupt(void * Add_pvChannel,u8 Copy_u8InterruptStatus)
{
	/*DECLARE RETURN STATUS AND INIT WITH OK*/
	Std_enuErrorStatus Loc_enuReturnStatus = OK;
	Usart_Regitsers_t * Loc_pstrUartChannel = Add_pvChannel;
